...
package org.luminedroid.systemui.keyguard
...
import org.luminedroid.systemui.keyguard.SmartspaceWidgetReader.Companion.SMARTSPACE_WEATHER_URI
...
class LumineKeyguardSliceProvider : KeyguardSliceProvider() {
    ...
    companion object {
        private const val TAG = "LumineKeyguardSliceProvider"
