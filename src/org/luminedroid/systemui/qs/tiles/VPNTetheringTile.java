 ...
 * Copyright (C) 2022-2023 The LibreMobileOS Foundation
 *
...
package org.luminedroid.systemui.qs.tiles;
...
public class VPNTetheringTile extends QSTileImpl<BooleanState> {
    ...
    public VPNTetheringTile(
        ...
        mSetting = new UserSettingObserver(secureSettings, mHandler, LumineSettings.Secure.TETHERING_ALLOW_VPN_UPSTREAMS,
